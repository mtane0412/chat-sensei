 ...
 *   疑問文まるごとの抽出(`filterQuestionSentenceTerms`。issue #100)、語数が上限を超えるリスト外の
...
const pipeline = createAutoPipeline<PickupDone>({
  ...
  // 抽出結果からは、文中に固有名詞を含む句と疑問文まるごとの抽出(issue #100)、語数が上限を超える
  // リスト外の語句(issue #104)を落とし、普通の単語・字義通りの句を高頻度語リスト・表現リストで
